                ...
                .into(mImageView, new Callback()
                {
                    ...
                    public void onSuccess()
                    {
                        ...
                        try
                        {
                            ...
                            {
                                final Downloader.Response response = Picasso.getDownloader(getActivity().getApplicationContext()).load(Uri.parse(file_url_with_referer), NetworkPolicy.NO_CACHE.ordinal());
