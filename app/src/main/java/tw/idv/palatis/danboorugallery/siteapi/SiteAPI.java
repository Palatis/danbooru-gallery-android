...
//
//	protected HttpURLConnection openConnection(URL url) throws MalformedURLException {
////        HttpURLConnection connection = sOkHttpClient.open(url);
//		HttpURLConnection connection;
//		switch (url.getProtocol().toLowerCase()) {
//			case "http":
//				connection = new HttpURLConnectionImpl(url, mOkHttpClient);
//				break;
//			case "https":
//				connection = new HttpsURLConnectionImpl(url, mOkHttpClient);
//				break;
//			default:
...
//
//	/**
//	 * Get the {@link java.io.File} that {@link android.app.DownloadManager} will save the file
//	 *
//	 * @param host the host this post is from
//	 * @param post the post itself
//	 * @return the {@link java.io.File} to be saved
//	 */
...
//				return PAGE_LIMIT_RELAXED;
//			case PAGE_LIMIT_TYPE_STRICT:
//				return PAGE_LIMIT_STRICT;
//		}
...
//			// content will not be changed, so skip all observer operations
//		}
//
//		@Override
