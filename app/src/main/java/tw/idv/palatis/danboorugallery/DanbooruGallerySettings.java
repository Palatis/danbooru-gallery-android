...
public class DanbooruGallerySettings {
	...
	public static final String KEY_PREF_DOWNLOAD_FULLSIZE = "pref_download_fullsize";
	...
	public static boolean getDownloadFullsize() {
		return sSharedPreferences.getBoolean(KEY_PREF_DOWNLOAD_FULLSIZE, false);
	}
